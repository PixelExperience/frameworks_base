...
public class CustomGlobalActions {

    private Context mContext;

    private static ICustomGlobalActions sService;
    private static CustomGlobalActions sCustomGlobalActionsInstance;

    private static final String TAG = "CustomGlobalActions";

    private CustomGlobalActions(Context context) {
        ...
        if (sService == null) {
            Log.wtf(TAG, "Unable to get CustomGlobalActionsService. The service either" +
    ...
    /**
     * Get or create an instance of the {@link com.android.internal.util.custom.globalactions.CustomGlobalActions}
     * @param context
     * @return {@link CustomGlobalActions}
     */
    public static CustomGlobalActions getInstance(Context context) {
        if (sCustomGlobalActionsInstance == null) {
            sCustomGlobalActionsInstance = new CustomGlobalActions(context);
        }
        return sCustomGlobalActionsInstance;
    }

    /** @hide */
    static public ICustomGlobalActions getService() throws RemoteException {
        if (sService != null) {
            return sService;
        }
        IBinder b = ServiceManager.getService(
                ContextConstants.CUSTOM_GLOBAL_ACTIONS_SERVICE);
        sService = ICustomGlobalActions.Stub.asInterface(b);
