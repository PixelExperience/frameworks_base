...
interface ILongScreenshotManager {
    ...
    void notifyLongshotScrollChanged(int x, int y, int oldx, int oldy) throws RemoteException;

    void notifyScrollViewSearchComplete(int top, int bottom, int scrollViewType) throws RemoteException;

    void notifyScrollViewTop(int viewTop);

    void notifyWindowLayerChange(IBinder windowToken) throws RemoteException;
