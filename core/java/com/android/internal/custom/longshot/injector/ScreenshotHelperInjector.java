...
public class ScreenshotHelperInjector {
    private static final String OP_SCREENSHOT_SERVICE = OpLongScreenshotManagerService.OP_SCREENSHOT_PACKAGE + ".TakeScreenshotService";
    ...
    public void takeScreenshot(final int screenshotType, final boolean hasStatus,
        ...
        synchronized (mScreenshotLock) {
            ...
            serviceIntent.setComponent(new ComponentName(OpLongScreenshotManagerService.OP_SCREENSHOT_PACKAGE, OP_SCREENSHOT_SERVICE));
