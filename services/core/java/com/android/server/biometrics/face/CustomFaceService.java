...
public class CustomFaceService {
    ...
    private Intent getServiceIntent() {
        Intent intent = new Intent("org.pixelexp.faceunlock.BIND");
        intent.setComponent(ComponentName.unflattenFromString(
                "org.pixelexp.faceunlock/org.pixelexp.faceunlock.service.FaceAuthService"));
        return intent;
    }

    public String getServicePackageName() {
        return "org.pixelexp.faceunlock";
    }
