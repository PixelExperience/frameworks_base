...
import com.android.server.custom.LineageSystemService;
    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_BOOT_COMPLETED) {
            ...
            int defaultMode = mContext.getResources().getInteger(
                    com.android.server.custom.R.integer.config_defaultLiveDisplayMode);
        ...
        if (counter == 0) {
            ...
            Notification.Builder builder = new Notification.Builder(mContext)
                    .setContentTitle(mContext.getResources().getString(
                            com.android.server.custom.R.string.live_display_title))
                    .setContentText(mContext.getResources().getString(
                            com.android.server.custom.R.string.live_display_hint))
                    .setSmallIcon(com.android.server.custom.R.drawable.ic_livedisplay_notif)
