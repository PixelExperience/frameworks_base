...
public class AssistManagerGoogle extends AssistManager {
    ...
    private void registerEnableReceiver(int i) {
        mContext.registerReceiverAsUser(mEnableReceiver, new UserHandle(i), new IntentFilter("com.google.android.systemui.OPA_ENABLED"), null, null);
    }
    ...
    private void updateAssistantEnabledState() {
        mOpaEnableDispatcher.dispatchOpaEnabled(UserSettingsUtils.load(mContentResolver));
    }
