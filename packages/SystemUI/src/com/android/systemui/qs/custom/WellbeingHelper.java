...
public class WellbeingHelper {
    private static final String mWellbeingPackage = "com.google.android.apps.wellbeing/com.google.android.apps.wellbeing.screen.ui.GrayscaleTileService";
    ...
    public static boolean shouldAddTile(Context context, ComponentName componentName) {
        if (componentName.flattenToString().equals(mWellbeingPackage)) {
            try {
                ...
                return !hardwareManager.isSupported(LineageHardwareManager.FEATURE_READING_ENHANCEMENT);
            } catch (Exception e) {
            }
        }
        return true;
