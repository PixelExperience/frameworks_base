...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    private void animateSliderTo(int target) {
        ...
        if (mBrightnessRampRateSlow > 0 && mBrightnessRampRateSlow != mDefaultBrightnessRampRateSlow)
            durationScale = Math.min(mDefaultBrightnessRampRateSlow / mBrightnessRampRateSlow, 3.0f);
