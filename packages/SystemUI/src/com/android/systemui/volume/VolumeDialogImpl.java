...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void initDialog() {
        ...
        if (isAudioPanelOnLeftSide()){
            if(isLandscape()){
                ...
                setLayoutGravity(layout.getLayoutParams(), Gravity.LEFT);
            }else{
        ...
        mODICaptionsTooltipViewStub = mDialog.findViewById(isAudioPanelOnLeftSide() ?
    ...
    private float getAnimatorX() {
        ...
        return isAudioPanelOnLeftSide() ? -x : x;
    }
    ...
    private boolean isAudioPanelOnLeftSide() {
        return !mShowActiveStreamOnly && mAudioPanelOnLeftSide;
    }
