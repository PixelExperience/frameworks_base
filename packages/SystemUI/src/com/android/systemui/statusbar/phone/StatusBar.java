...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mNeedsNavigationBar = NavbarUtils.hasNavbarByDefault(mContext);
    ...
    private void updateNavigationBar() {
        if (mDisplayId == Display.DEFAULT_DISPLAY &&
            ...
            boolean shouldForceNavBar = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.NAVIGATION_BAR_SHOW,
                     0, UserHandle.USER_CURRENT) == 1;
            boolean forcedVisibility = mNeedsNavigationBar || shouldForceNavBar;
