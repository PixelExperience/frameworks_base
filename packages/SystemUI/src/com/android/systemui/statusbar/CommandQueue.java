...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_IN_DISPLAY_FINGERPRINT_ENROLL_STATE_CHANGED = 50 << MSG_SHIFT;
    ...
    public interface Callbacks {
        ...
        default void onInDisplayFingerprintEnrollStateChanged(boolean enrolling) { }
    ...
    public void onInDisplayFingerprintEnrollStateChanged(boolean enrolling) {
        synchronized (mLock) {
            mHandler.obtainMessage(MSG_IN_DISPLAY_FINGERPRINT_ENROLL_STATE_CHANGED, enrolling ? 1 : 0, 0)
                    .sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_SHOW_IN_DISPLAY_FINGERPRINT_VIEW:
                    ...
                    break;
                case MSG_IN_DISPLAY_FINGERPRINT_ENROLL_STATE_CHANGED:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).onInDisplayFingerprintEnrollStateChanged(msg.arg1 > 0);
                    }
                    break;
