...
public class NetworkTraffic extends TextView {
    ...
    protected static final int MY_MODE = MODE_QS;
    ...
    private Handler mTrafficHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            final boolean enabled = mMode == MY_MODE && mScreenOn && isConnectionAvailable();
    ...
    protected void init(){
        ...
        mTxtFont = getResources().getString(com.android.internal.R.string.config_headlineFontFamilyMedium);
    ...
    protected void updateTrafficDrawable() {
        ...
        if (mMode == MY_MODE && (mIndicatorUp || mIndicatorDown)) {
            if (mIndicatorUp) {
    ...
    protected void updateVisibility() {
        if (mMode == MY_MODE && mTrafficVisible) {
